...
prompt: ahora ayudame con la estación 3:
#### **Estación 3: Diseño y Modelado**
* **Objetivo:** Visualizar y estructurar la interfaz antes de escribir código.
...
Genera un archivo llamado design.jpg con el wireframe o mockup que cumpla con la estructura de la web descrita en la estación 2 y que detallaste en el siguiente código html:
